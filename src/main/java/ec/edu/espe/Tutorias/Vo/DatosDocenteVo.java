...
public class DatosDocenteVo implements Serializable {
	...
	public DatosDocenteVo() {}
	public DatosDocenteVo(int PIDM, String ID, String CEDULA, String NOMBRES, String CORREO_INSTITUCIONAL, String CORREO_PERSONAL) {
		this.PIDM= PIDM;
		this.CEDULA= ID;
		this.CEDULA= CEDULA;
